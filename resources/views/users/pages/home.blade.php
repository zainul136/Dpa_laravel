                    ...
                    <div class="row property-row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 property-info">
                            ...
                            <div class="property-location"
                                 style="font-weight: bold;color: #FF851B;font-size: 0.9em;   font-family: Century Gothic, sans-serif;margin: 5px 0 5px 0">

                                <input name="pid" class="pid" type="text" value="" hidden/>
                            ...
                            <div class="row-fotter">
                                <div class="row-fotter-content"><i
                                        class="fa fa-arrows-alt">&nbsp;&nbsp;</i><span>{{$property->land_area}}</span><span>{{$property->unit}}</span>
                                </div>
