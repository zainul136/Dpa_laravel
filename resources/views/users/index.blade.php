            ...
            <div id="exTab1" class="container">
                ...
                <ul class="nav nav-pills red hidden-xs hidden-sm" style="margin-left: 50px;">
                    ...
                    @if(!empty($status))
                        ...
                        <li id="rent" class="change_active @if($status === 'rent') active @endif"><a href="#rent"
                                                                                                     data-toggle="tab">Rent</a>
                        </li>
                        <li id="wanted" class="change_active @if($status === 'wanted') active @endif"><a href="#wanted"
                                                                                                         data-toggle="tab">Wanted</a>
                        </li>
                    @else
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-9" style="height: auto">
            ...
            @foreach($properties as $key=>$property)
                <div class="col-xs-12 col-sm-6 col-md-6" style="margin-top: 10px; margin-bottom: 10px; ">
                    <div class="row">
                        <div class="col-xs-12 col-sm-10 col-md-11 card">
                            <div class="row">
                                <div class="col-xs-12 card-pic">
                                    ...
                                    <img src="{{url('assets/property-images',json_decode(trim($property->images[0]->image_name,'[]'))??'')}}" style="max-height: 200px; min-height: 200px;"/>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 line-12"><i class="fa fa-bookmark" aria-hidden="true">&nbsp;&nbsp;</i>{{$want->land_area}}
                                            &nbsp;{{$want->unit}}&nbsp;For&{{$want->status}}</div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 line-12"><i class="fa fa-bookmark" aria-hidden="true">&nbsp;&nbsp;</i>{{$rent->land_area}}
                                            &nbsp;{{$rent->unit}}&nbsp;For&{{$rent->status}}</div>
        ...
        @foreach($sales as $key=>$property)
            ...
            <div class="col-12 col-sm-6 col-md-4" style="margin-top: 10px; margin-bottom: 10px:">
                <div class="row">
                    <div class="col-xs-12 col-sm-10 col-md-11 card">
                        <div class="row">
                            <div class="col-xs-12 card-pic">
                                <div class="card-purpose"><span>For {{$property->status}}</span></div>
                                <img src="{{url('assets/property-images',json_decode(trim($property->images[0]->image_name,'[]')) ??'')}}"
                            ...
                            <div class="col-xs-12 card-view_details"><a href="{{route('property-detail',$property->id )}}"><i class="fa fa-external-link" aria-hidden="true">&nbsp;&nbsp;&nbsp;</i>VIEW  DETAILS</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @if(($rents))
            ...
            <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 10px; margin-bottom: 10px;">
                <div class="row topMargin">
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col-md-4 topMargin1">
                                <img  src="{{url("users/assets/images/explore/fdjh.png")}}"
                        ...
                        <div class="row">
                            <div class="col-md-4 topMargin1">
                                <img src="{{url("users/assets/images/explore/Cash-Icon-9uyhj.png")}}"
                                     style="width: 70px;height: 70px;">
                            </div>
                            <div class="col-md-8">
                                <h5>Pot Finder</h5>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-4 topMargin1">
                                <img src="{{url("users/assets/images/explore/Layer 3.png")}}"
                                     style="width: 70px;height: 70px;">
                            </div>
                            <div class="col-md-8">
